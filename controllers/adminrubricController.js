...
// search for particular rubric based assessment,class and subject
...
// search for particular rubric based class and subject
exports.getRubricBySubject = async(req,res)=>{
    console.log("The req body is",req.body);
    try{
        const rubrics = await adminRubric.find(req.body)
        res.status(200).json({
            status:'success',
            data:{rubrics}
        })
